...
//     div1.innerText = `${name} ${surname} ${age}`;
//     document.body.append(div1);
// });
// document.body.append(inputName, inputSurname, inputAge, button);
//

// ==========================
// є сторінка, на якій є блок, в якому знаходиьтся цифра. написати код, який при кожному
// перезавантажені сторінки буде додавати до неї +1
//  let div1 = document.createElement("div");
//  div1.innerText = "0";
//
//
// document.body.onload = function (eo) {
//     let number = localStorage.getItem("myNumber") || +div1.innerText;
//     number++;
